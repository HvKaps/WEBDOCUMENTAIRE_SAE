...
playPauseButton1.addEventListener('click', () => {
    if (isPlaying1) {
        audioPlayer1.pause();
        isPlaying1 = false;
        playPauseButton1.src = './IMAGE/AUDIO/play-button 1.png'; 
    } else {
        audioPlayer1.play();
        isPlaying1 = true;
        playPauseButton1.src = './IMAGE/AUDIO/pause.png'; 
    }
});
...
playPauseButton2.addEventListener('click', () => {
    if (isPlaying2) {
        audioPlayer2.pause();
        isPlaying2 = false;
        playPauseButton2.src = './IMAGE/AUDIO/play-button 1.png'; 
    } else {
        audioPlayer2.play();
        isPlaying2 = true;
        playPauseButton2.src = './IMAGE/AUDIO/pause.png'; 
    }
});
